# -*- coding: utf-8 -*-
"""24_02_RCA_parallel_Median_based_clustering.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1GLUJ9_yOp96KdIerlfTZljKs4fXNTBhx
"""
...
class RCAC:
  ...
  def fit(self):
    ...
    for iclust in range(self.num_threads):
      print('Thread: ',iclust)
      init_clusters_ = threading.Thread(target=self.cellular_automata_clustering, args=(rule_list,num_of_splits, rules_sep[iclust], split_enc, iclust, self.trials, window_size))
...
#**********************Our Proposed Algorithm Starts Here***************************
  ...
  def cellular_automata_clustering(self,rule_list, split, rules_comb, encoding, thread_no, trials=-1, window_size = 5):
    better_score_list = []
    best_CA_sill = -10000
    best_rule = []
    output_data = []
